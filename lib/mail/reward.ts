const rewardMail = (displayName: string) => {
  return `
    <!DOCTYPE html>
    <html lang="en">
      <head>
        ...
        >
          ...
          <div style="background-color: #111115; padding: 30px">
            ...
            <p
              ...
              "
            >
              Hello ${displayName}! Your skin prize has been successfully delivered to your account.
            </p>

            <div style="text-align: center; margin: 30px 0;">
              <div style="background-color: #1a1a1a; padding: 20px; display: inline-block; border: 1px solid #4CAF50;">
                <div style="width: 80px; height: 80px; background: #f8f9fa; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px; border: 3px solid #4CAF50; font-size: 40px;">🎁</div>
                <h3 style="color: #4CAF50; margin: 0 0 10px 0; font-size: 18px;">Prize Delivered Successfully!</h3>
                <p style="margin: 0; color: #4CAF50; font-size: 16px; font-weight: bold;">Check your inventory</p>
              </div>
            </div>
            ...
            <p
              ...
              "
            >
              You should be able to see your prize in your inventory or receive it through your configured delivery method.
            </p>
