      ...
      <body>
        ...
        >
          ...
          <div style="background-color: #111115; padding: 30px">
            ...
            <p style="Margin:0;mso-line-height-alt:24px;font-size:16px;line-height:150%;color:#cecece;text-align:center;">
              Congrats on winning a skin on CS2DLE! <span style="font-weight:700;">To claim your prize, just add a crypto address to your CS2DLE profile</span> and we'll send it straight to your wallet.
            </p>
...
export default rewardNotifyMail;
