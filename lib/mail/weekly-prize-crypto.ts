  ...
  return `
    ...
    <html lang="en">
      <head>
        ...
        <title>Weekly Prize Sent - CS2DLE</title>
      </head>
      <body>
        <div
          style="
        ...
        >
          ...
          <div style="background-color: #111115; padding: 30px">
            <h2 style="color: #ffffff; margin-top: 0; width: 100%; text-align: center">
              💰 Weekly Prize Sent to Your Wallet!
            </h2>
            <p
              style="
                font-size: 16px;
              ...
              "
            >
              Congratulations ${displayName}! Your weekly prize has been converted to cryptocurrency and sent to your ${cryptoType} wallet.
            </p>
    ...
    weekEndDate
            ...
            <p
              ...
              "
            >
              The equivalent value in ${cryptoType} has been sent to your registered wallet address. 
              Please allow a few minutes for the transaction to be confirmed on the blockchain.
            </p>
            ...
            <div style="text-align: center; margin: 20px 0;">
              <div style="background-color: #1a1a1a; padding: 15px; display: inline-block; border-radius: 5px;">
                <p style="margin: 0; color: #40ff00; font-size: 14px;">
                  ✅ Payment Status: <strong>Sent</strong>
                </p>
                <p style="margin: 5px 0 0 0; color: #888; font-size: 12px;">
                  Check your ${cryptoType} wallet for the incoming transaction
                </p>
              </div>
            </div>
...
export default weeklyPrizeCryptoMail;
